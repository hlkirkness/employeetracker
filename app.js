...
const viewAllEmployees = (req, res) => {
    const sql = `SELECT employee.first_name, employee.last_name, role.salary, role.title, department.name as "Department Name", Manager.first_name AS "Manager" FROM employee
        ...
        inquirer
            .prompt([
                ...
                },
                {
                    name: "salary",
                    type: "input",
                    messager: "What is the salary for this role?",
                },
                {
                    name: "choice",
                    type: "list",
